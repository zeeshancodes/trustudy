// Copyright (C) www.tutorialrepublic.com
...
function setColor(){
    ...
    if(btnSelector == ".btn.btn-success" || btnSelector == ".btn.btn-success.disabled"){
        ...
        $("#bgColor").val("5CB85C");
        $("#topColor").val("5CB85C");
        $("#bottomColor").val("419641");                    
        $("#borderTopColor").val("3E8F3E");
        $("#borderHrColor").val("3E8F3E");
        $("#borderBottomColor").val("3E8F3E");
    }
...
$(document).ready(function(){
    ...
    var copyHTML = new ClipboardJS("#copyHTML");
    ...
    // HTML copy to clipboard
    var copyCSS = new ClipboardJS("#copyCSS");
