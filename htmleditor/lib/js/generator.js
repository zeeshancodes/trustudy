// Copyright (C) 2014 www.tutorialrepublic.com
...
$(function(){
    ...
    $(".element-type label").click(function(){
        ...
        if($(this).children("input").attr("value")=="a"){
            ...
            if(iconCode.length){
                if($('.glyphicon-position label.active input').val() == "left"){
                    $("#result .btn").prepend(" ");
                    $("#result .btn").prepend(iconCode);
                }
                if($('.glyphicon-position label.active input').val() == "right"){
                    $("#result .btn").append(" ");
    ...
    $(".glyphicon-position label").click(function(){
